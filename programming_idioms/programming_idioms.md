In this folder, a number of programming idioms tasks from [programming idioms](https://www.programming-idioms.org/about#about-block-all-idioms) are implemented
